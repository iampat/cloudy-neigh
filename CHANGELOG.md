...
- `kvfs`: Layer 2 Key-Value Store foundation.
  ...
  - `kvfs/store.go`: Configurable synchronous/asynchronous engine with Pebble-style Options and WriteOptions, point reads, writes, deletes, background WAL compaction, and zero-copy branching.
