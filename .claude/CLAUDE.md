...
Babysit every open PR until it's merged or closed. The `babysit-prs` skill
defines the steps (poll comments, address + reply, keep CI green, ask
clarifications as PR comments).
